...
function Table<T extends Record<string, unknown> & { id: number }>({
  ...
  return (
    <>
      <div className="responsive-table rounded-md p-2.5 overflow-auto mt-7.5 neon-border h-90 flex flex-col">
        ...
        <div className="min-w-250 flex justify-between items-center mt-auto pt-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={onNext}
              className="cursor-pointer p-2 w-10 h-10 btn-primary rounded-full"
            >
              <FontAwesomeIcon
                icon={faArrowRight}
                className="text-lg font-bold"
